...
public class RadarSystemSprint1MainObs implements IApplication{
...
//			RadarSystemConfig.RadarGuiRemote    = true;
	...
	protected void configure() {
	    ...
	    //Controller
	    controller = ControllerObserver.create(led, sonar, radar);	 
	}
...
//Get the system components 
 	...
 	public ISonarObservable getSonar() { return sonar; }
 	public ControllerObserver getController() { return controller; }
